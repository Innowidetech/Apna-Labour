    ...
    <nav className="bg-white fixed w-full z-50 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          {/* Logo */}
          <div
            className="flex-shrink-0 text-2xl font-bold italic text-[#003049] cursor-pointer"
            onClick={() => navigate("/")}
          >
            Apna Labour
          </div>
      ...
      {isOpen && (
        <div className="md:hidden px-4 pb-4 space-y-4 bg-white shadow-md">
          ...
          <button className="flex items-center bg-[] text-white px-4 py-2 rounded-lg text-sm w-full">
