...
const Footer = () => {
  return (
    <footer className="bg-[#071B3A] text-white px-6 py-12 mt-auto">
      ...
      {/* ⭐ Center Aligned Heading Added */}
      <h1 className="text-center text-3xl font-bold italic mb-10 tracking-wide">
        Apna Labour
      </h1>

      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 sm:gap-16 md:gap-24">
          ...
          <div className="flex items-center mt-5 space-x-3">
            <div className="flex items-center border border-white rounded-md px-3 py-2">
              ...
              <input
                ...
                className="bg-transparent text-white placeholder-white focus:outline-none w-40 text-sm"
              />
            </div>

            <button className="bg-[#0EA5E9] px-2 py-2 rounded-md text-white text-sm">
              Subscribe
            </button>
          </div>
        </div>
