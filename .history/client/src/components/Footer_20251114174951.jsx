...
const Footer = () => {
  ...
  className="px-4 py-2 rounded-l-md text-white placeholder-white bg-transparent border border-white w-52 text-sm focus:outline-none"
/>

            <button className="bg-[#0EA5E9] px-4 py-2 mr-4 rounded-r-md text-white text-sm">
              Subscribe
            </button>
          </div>
        </div>
