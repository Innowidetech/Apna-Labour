  ...
  const handleSubmitReview = () => {
    ...
    dispatch(addReview({ unitId: itemId, rating, feedback }))
      ...
      .then(() => {
        ...
        dispatch(fetchBookings()); // refresh bookings to reflect review
      });
  };
            ...
            <div className="bg-white rounded-xl p-6 w-full max-w-md">
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  ...
                  disabled={reviewLoading || reviewModal.rating === 0}
            ...
            <div className="flex flex-col md:items-end mt-3 md:mt-0">
              ...
              {booking.status === "Completed" && openReviewModal && (
                <button
                  ...
                  className="mt-2 px-3 py-1 rounded-lg bg-blue-600 text-white text-sm hover:bg-blue-700"
                >
                  Review
                </button>
              )}
