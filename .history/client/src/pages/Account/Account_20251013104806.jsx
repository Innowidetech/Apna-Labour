...
const Account = () => {
  ...
  const handleDelete = async () => {
    try {
      ...
      await axios.delete("https://apnalabour.onrender.com/api/customer/profile", {
  ...
  return (
    <>
      <div className="min-h-screen bg-white flex flex-col items-center px-4 py-8">
        ...
        {/* Title */}
        <h2 className="text-lg font-semibold mb-4 w-full max-w-xl">
        ...
        <div className="flex flex-col items-center mb-6">
          <div className="relative">
            <div className="w-20 h-20 rounded-full bg-gray-200 overflow-hidden flex items-center justify-center text-gray-600">
              {formData.image ? (
                <img
        ...
        <div className="w-full max-w-xl space-y-5">
          ...
          {/* Manage Address */}
          <div className="mt-6">
            <h3 className="font-semibold text-gray-800 mb-3">Manage Address</h3>
          ...
          <button
            onClick={handleSave}
            disabled={loading}
            className="w-full bg-gray-700 text-white py-2 rounded-md mt-5 hover:bg-gray-800 text-sm"
          >
            {loading ? "Saving..." : "Save"}
          </button>
