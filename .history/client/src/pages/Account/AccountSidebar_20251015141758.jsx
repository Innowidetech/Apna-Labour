...
const AccountSidebar = ({ handleLogout, handleDeactivate }) => {
  ...
  const handleFilterChange = (e) => {
    ...
    dispatch(fetchFilteredBookings(value)); // Send year or "last30" to API
  };
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-gray-100 border-r overflow-y-auto transform transition-transform duration-300
        ${isOpen ? "translate-x-0" : "-translate-x-full"} md:translate-x-0 md:static md:inset-auto md:flex-shrink-0`}
      >
        {/* Profile */}
