...
const Account = () => {
  ...
  const accountData = useSelector((state) => state.customer?.profile);
  const loading = useSelector((state) => state.customer?.loading);
  const error = useSelector((state) => state.customer?.error);
  const successMessage = useSelector((state) => state.customer?.message);
  ...
  const handleSave = async () => {
    ...
    data.append("address.HNo", formData.address.HNo);
    ...
    data.append("address.townCity", formData.address.townCity);
    ...
    try {
      await dispatch(updateCustomerProfile(data)).unwrap();
