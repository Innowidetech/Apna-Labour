...
const Bookings = () => {
  ...
  const [filterValue, setFilterValue] = useState(""); // For sidebar filter
  ...
  const handleFilterChange = (value) => {
    ...
    dispatch(fetchFilteredBookings(value)); // API should return filtered bookings
  };
  ...
  return (
    <div className="flex flex-col md:flex-row bg-gray-50 min-h-screen">
      {/* Sidebar */}
      <AccountSidebar
        handleFilterChange={handleFilterChange} // Pass handler to sidebar
      />
