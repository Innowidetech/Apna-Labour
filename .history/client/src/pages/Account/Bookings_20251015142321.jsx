...
const Bookings = () => {
  ...
  const handleFilterChange = (value) => {
    ...
    dispatch(fetchFilteredBookings(value)); // API returns { upcoming: [...], past: [...] }
  };
  ...
  // Use API returned arrays if available, else fallback to empty
  ...
  return (
    <div className="flex flex-col md:flex-row bg-gray-50 min-h-screen">
      {/* Sidebar */}
      <AccountSidebar handleFilterChange={handleFilterChange} />
