...
import { fetchFilteredBookings } from "../../redux/bookingSlice"; // ✅ import your filter thunk
...
const AccountSidebar = ({ handleLogout, handleDeactivate }) => {
  ...
  // ✅ Trigger filtered bookings API
  const handleFilterBookings = () => {
    dispatch(fetchFilteredBookings(2025));
  };
  ...
  return (
    <>
      ...
      >
        ...
        {/* ✅ Filter Bookings Button (only visible on /bookings) */}
