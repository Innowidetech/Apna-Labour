...
import { fetchFilteredBookings, fetchBookings } from "../../redux/bookingSlice";
...
const AccountSidebar = ({ handleLogout, handleDeactivate }) => {
  ...
  const handleFilterChange = (e) => {
    ...
    if (value) {
      ...
      setIsOpen(false); // optional for mobile UX
    } else {
      dispatch(fetchBookings()); // show all bookings again
    }
  };
  ...
  return (
    <>
      ...
      >
        ...
        {/* ✅ Filter Dropdown (only visible on Bookings page) */}
        {isBookingsPage && (
