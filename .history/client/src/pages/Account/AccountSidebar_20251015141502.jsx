...
const AccountSidebar = ({ handleLogout, handleDeactivate }) => {
  ...
  // ✅ Updated filter logic based on backend
  const handleFilterChange = (e) => {
    const value = e.target.value;
    setFilterValue(value);

    if (value) {
      // Dispatch filtered bookings API call
      dispatch(fetchFilteredBookings(value));
    } else {
      // If user selects "All", fetch all bookings
      dispatch(fetchFilteredBookings(""));
    }
  };
  ...
  return (
    <>
      ...
      >
        ...
        {/* ✅ Updated Filter Dropdown (for backend-supported filters) */}
        {isBookingsPage && (
