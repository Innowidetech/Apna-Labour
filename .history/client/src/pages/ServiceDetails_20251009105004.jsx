...
const ServiceDetails = () => {
  ...
  return (
    <>
      ...
      <div className="px-6 md:px-16 py-6">
        {isCasualLabourService && !isLoadingCasualLabour && casualLabour.length > 0 && (
  ...
  <div className="fixed inset-0 flex items-center justify-center bg-blu bg-opacity-50 z-50">
    <div className="bg-white p-5 rounded-2xl shadow-xl w-11/12 max-w-md relative max-h-[85vh] overflow-y-auto">
      <button
        className="absolute top-3 right-3 text-gray-600 hover:text-gray-800"
