...
const slugify = (text) =>
  ...
  md:absolute md:-bottom-6 md:right-6 bg-white shadow-lg"
>
  {/* Header */}
  <div className="flex items-center justify-between mb-3 sm:mb-3">
    ...
    <button className="p-1.5 rounded-full border bg-gray-100 hover:bg-gray-200">
  ...
  <div className="flex justify-between items-center gap-1 sm:gap-2">
    {services.map((service, i) => (
      ...
      >
        <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-18 md:h-18 rounded-full overflow-hidden shadow-md flex items-center justify-center bg-gray-50">
          <img
            src={service.img}
            alt={service.title}
        ...
        <p className="mt-1 text-[9px] sm:text-[11px] md:text-xs font-medium text-gray-700 text-center leading-tight truncate w-full">
          {service.title}
        </p>
      </div>
    ))}
