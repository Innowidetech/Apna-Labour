...
import { FaUsers, FaUser } from "react-icons/fa";  // Import icons
...
const ServiceDetails = () => {
  ...
  // Replace this with the actual ID that represents casual labour service category
  ...
  useEffect(() => {
    ...
    if (id) {
      ...
      // Only fetch subcategories if NOT casual labour service
      ...
      setActiveLabourType(null);  // Reset active button on id change
    }
  ...
  const fetchCasualLabour = async (type) => {
    try {
      ...
      setErrorCasualLabour(null);
      setCasualLabour([]);
      setActiveLabourType(type); // Set active button here
  ...
  return (
    <>
      {/* Hero Section */}
    <section className="bg-[#EDF2FB] py-5 px-6 md:px-16">
  <div className="container mx-auto flex flex-col md:flex-row justify-between items-end">
    ...
    <div className="w-full md:w-1/2 flex justify-end">
      <img
        ...
        alt={heroData.title}
        className="max-w-xs md:max-w-sm lg:max-w-md max-h-40 object-contain"
      />
    </div>
  </div>
</section>
    ...
    {/* Buttons for Casual Labour just below hero, aligned right */}
{isCasualLabourService && (
  <div className="flex justify-end gap-4 mt-4 px-6 md:px-16">
    <button
    ...
    >
      ...
      <div className="px-6 md:px-16 py-6">
        {/* Show Subcategories only if NOT Casual Labour */}
        {!isCasualLabourService && (
          <>
        ...
        {/* Casual Labour Section when NOT in Hero */}
        {isCasualLabourService && (
          <>
