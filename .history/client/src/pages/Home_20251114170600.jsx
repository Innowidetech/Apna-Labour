    ...
    <div>
            ...
            <div className="flex justify-between gap-2 sm:gap-3">
              {services.map((service, i) => (
                <div key={i} className="flex flex-col items-center flex-1">
                  ...
                  {/* Title */}
                  <p className="mt-1 text-[10px] sm:text-xs font-medium text-gray-700 text-center leading-tight">
                    {service.title}
                  </p>
      ...
      <section className="relative py-40 px-6 md:px-12 bg-[#F1F1E6] rounded-2xl">
        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          {/* Centered Button */}
          <button className="mt-4 px-6 py-2 bg-[#003049] text-white font-semibold w-28 py-2 rounded-xl shadow-md transition hover:bg-[#333] text-white rounded-full text-sm font-medium hover:bg-blue-800">
            Book Now
          </button>
