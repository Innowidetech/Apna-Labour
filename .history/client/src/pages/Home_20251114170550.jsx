    ...
    <div>
      ...
      <section className="relative py-40 px-6 md:px-12 bg-[#F1F1E6] rounded-2xl">
        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          {/* Centered Button */}
          <button className="mt-4 px-6 py-2 bg-[#003049] text-white font-semibold w-28 shadow-md transition hover:bg-[#333 rounded-full text-sm font-medium hover:bg-blue-800">
            Book Now
          </button>
