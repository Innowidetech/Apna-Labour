...
const ServiceDetails = () => {
  ...
  // Handle booking (add to localStorage cart)
  const handleBooking = () => {
    ...
    localStorage.setItem("labourCart", JSON.stringify([...existingCart, newItem]));
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white p-6 rounded-2xl shadow-xl w-11/12 max-w-md relative">
            ...
            <div className="flex flex-col items-center">
              ...
              <button
                className="bg-[#003049] text-white px-6 py-2 rounded-lg hover:bg-[#00243a] transition w-full"
