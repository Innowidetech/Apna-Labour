              ...
              <>
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 w-full max-w-md mx-auto">
                  ...
                  <div className="border-b border-gray-100 py-4">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-gray-500 text-lg ]">📅</span>
                      <h3 className="text-white text-sm font-medium">Slot booking</h3>
                    </div>
                    <button
                      className="w-full bg-[#003049] text-gray-400 py-2 rounded-md font-medium text-sm transition-colors active:bg-[#003049] active:text-white"
