...
const Account = () => {
  ...
  const handleLogout = () => {
    localStorage.removeItem("authToken"); // Adjust if you use another storage for auth
    toast.success("Logged out successfully!");
    setTimeout(() => {
      window.location.href = "/login"; // Adjust redirect path if necessary
    }, 1500);
  };
        ...
        <div className="w-full md:w-64 bg-gray-100 flex-shrink-0 ml-2">
          <div className="p-6 flex flex-col items-center">
            ...
            <h2 className="font-bold text-lg mb-6 text-center">
              Hello {formData.fullNamename || "User"}
            </h2>
          </div>
