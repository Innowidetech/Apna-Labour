...
const LabourCart = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
      ...
      {/* RIGHT SIDE */}
      <div className="flex-1 p-6 md:p-10 flex flex-col items-center bg-white">
        ...
        <div className="border rounded-xl p-6 shadow-sm w-full max-w-md">
          ...
          <button className="w-full bg-blue-900 text-white py-2 rounded-md font-medium hover:bg-blue-800 transition">
            Pay NOW
          </button>
        </div>
      </div>
