...
const ServiceDetails = () => {
  ...
  // Handle Booking
  const handleBooking = () => {
    if (!selectedLabour || !startDate || !endDate || !workLocation || !purpose) {
    ...
    const newItem = {
      ...
      startDate,
      endDate,
      numberOfWorkers: activeLabourType === "Team" ? numberOfWorkers : 1,
      workLocation,
      purpose,
    };
  ...
  return (
    <>
      ...
      <div className="px-6 md:px-16 py-6">
        ...
        {/* Subcategories & Services Section remains unchanged */}
      </div>
