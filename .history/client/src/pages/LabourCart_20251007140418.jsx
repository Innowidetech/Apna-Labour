  ...
  return (
    <div className="flex flex-col md:flex-row px-6 md:px-16 py-6 gap-8">
      ...
      <div className="flex-1 space-y-6 bg-white p-6 shadow-lg rounded-xl">
        <h2 className="text-2xl font-bold mb-4 text-center">Your Labour Cart</h2>
        {cartItems.length === 0 ? (
          ...
          cartItems.map((item) => (
            <div
              ...
              className="border rounded-xl p-4 flex flex-col md:flex-row gap-6 items-start md:items-center"
            >
              <img
              ...
              <div className="flex-1 space-y-1 md:space-y-2">
                ...
                <p>
                  <span className="font-semibold">Skill:</span> {item.labourer.skill || "General Labour"}
                </p>
                <p>
                  <span className="font-semibold">Phone:</span> {item.labourer.phone || "N/A"}
                </p>
                <p>
                  <span className="font-semibold">Date:</span> {item.startDate} → {item.endDate}
                </p>
                <p>
                ...
                <p>
                  ...
                  {item.additionalDetails || "No additional notes"}
                </p>
                <p className="font-bold text-lg">₹{getTotalCost(item)}</p>
              </div>
              <div>
                <button
                  className="text-red-600 text-sm underline mt-2 md:mt-0"
      ...
      <div className="w-full md:w-96 border rounded-xl p-4 space-y-6 bg-white shadow-lg">
        ...
        <div className="border-t pt-4 space-y-2">
          ...
          <div className="flex justify-between">
            ...
            <span>₹{cartItems[0]?.labourer.cost?.toFixed(2) || 0}</span>
          </div>
          <div className="flex justify-between">
