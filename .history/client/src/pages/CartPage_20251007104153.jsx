...
<>
  <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 w-full max-w-md mx-auto">
    ...
    <div className="border-b border-gray-100 py-4">
      ...
      <button
        className="w-full bg-[#001F3F] hover:bg-[#002c5c] text-white py-2 rounded-md font-medium text-sm transition-colors"
    ...
    <div className="border-b border-gray-100 py-4">
      ...
      <button
        className="w-full bg-gray-200 text-gray-400 py-2 rounded-md font-medium text-sm disabled:cursor-not-allowed"
    ...
    <div className="py-4">
      ...
      {addressSaved ? (
        <button
          className="w-full bg-green-600 hover:bg-green-700 text-white py-2 rounded-md font-medium text-sm transition-colors"
        ...
        <button
          className="w-full bg-gray-200 text-gray-400 py-2 rounded-md font-medium text-sm cursor-not-allowed"
        >
          Proceed to checkout
        </button>
      )}
