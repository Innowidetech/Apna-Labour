...
const Account = () => {
  ...
  // Separate state for sidebar display to avoid live updates of the form image input
  ...
  useEffect(() => {
    ...
    setDisplayData({
      ...
      image: customer.imageUrl || null, // URL string
    });
  }, [accountData]);
  ...
  const handleImageChange = (e) => {
    ...
    // Update sidebar preview immediately on file select
    if (file) {
      ...
      <div className="flex flex-col md:flex-row min-h-screen bg-gray-100">
        ...
        <div className="flex-1 p-4 md:p-10">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md max-w-2xl mx-auto space-y-4">
            ...
            <button
              onClick={handleSave}
              className="bg-green-600 text-white py-2 px-4 rounded-md hover:bg-green-700 mt-6 w-full"
              disabled={loading}
            >
              {loading ? "Saving..." : "Save"}
            </button>
