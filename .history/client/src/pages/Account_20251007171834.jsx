...
import { fetchAccountProfile } from "../redux/accountSlice"; // ✅ Import slice thunk
...
const Account = () => {
  ...
  // ✅ Update formData when API data changes
  useEffect(() => {
    if (accountData) {
      setFormData({
        ...
        house: accountData.address?.house || "",
        building: accountData.address?.building || "",
  ...
  const handleSave = () => {
    ...
    // Optionally add PUT API logic here later for updating the profile
  };
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      {/* Left Section (not sidebar anymore, simplified) */}
