      ...
      <div className="flex-1 space-y-6 bg-white p-6 shadow-lg rounded-xl">
        ...
        <div className="border rounded-xl p-4 flex flex-col md:flex-row gap-6 items-start md:items-center">
          ...
          <div className="flex-1 space-y-2">
            ...
            <p>
              <span className="font-semibold">Duration:</span> {cartItem.duration} day(s)
            </p>
            <p>
              <span className="font-semibold">Labour Name:</span> {cartItem.labourer.name}
            </p>
            <p>
              <span className="font-semibold">Phone:</span> {cartItem.labourer.phone}
            </p>
            <p>
              <span className="font-semibold">Work Location:</span> {cartItem.location || "N/A"}
            </p>
            <p>
              <span className="font-semibold">Additional Details:</span> {cartItem.additionalDetails || "-"}
            </p>
          </div>
        </div>
      </div>
