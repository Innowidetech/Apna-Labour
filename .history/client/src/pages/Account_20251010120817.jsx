...
const Account = () => {
  ...
  // Update formData and sidebar display data when accountData changes
  useEffect(() => {
  if (!accountData) return;

  // accountData is the profile object, no need to do accountData.profile
  setFormData({
  ...
  setDisplayData({
    name: accountData.name || "",
    image: accountData.image || accountData.picture || null,
  });
}, [accountData]);
