...
const Account = () => {
  ...
  // 🟢 Static display name (not updated while typing)
  ...
  useEffect(() => {
    ...
    // Priority for displayName: name > email > phoneNumber
    setDisplayName(profile?.name || profile?.email || profile?.phoneNumber || "User");
  }, [accountData]);
  ...
  const handleSave = async () => {
    try {
      ...
      await dispatch(fetchAccountProfile()); // refresh data after save
    } catch (err) {
      ...
      <div className="flex flex-col md:flex-row min-h-screen bg-gray-100">
        ...
        <div className="w-full md:w-64 bg-gray-100 flex-shrink-0 ml-2">
          <div className="p-6 flex flex-col items-center">
            ...
            {/* 🟢 Uses displayName instead of formData.name */}
