            ...
            {isLoadingLabourDetails ? (
              ...
              <div className="flex flex-col items-center">
                <img
                  ...
                  alt={labourDetails.name}
                  className="w-24 h-24 rounded-full border mb-2"
                />
                <h2 className="text-lg font-bold">{labourDetails.name}</h2>
                <p className="text-sm text-gray-500 mb-1">
                  {labourDetails.skill || "Labour Skill Info"}
                </p>
                <p className="text-sm text-gray-500 mb-1">
                  Experience: {labourDetails.experience || "N/A"}
                </p>
                <p className="text-sm text-gray-500 mb-1">
                ...
                <p className="text-sm text-gray-500 mb-1">
                  Distance: {labourDetails.distance || "N/A"}
                </p>
                <p className="text-sm text-gray-500 mb-1">
                  Description: {labourDetails.description || "No additional info"}
                </p>
              </div>
            )}
          </div>
