    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className="w-64 bg-white shadow-md">
        <div className="p-6 flex flex-col items-center">
          ...
          <h2 className="font-bold text-lg mb-6">Hello Andrew Johnson</h2>
        </div>
        <ul className="text-gray-600">
          {["My Account", "My Bookings", "Payments", "My rating & reviews", "Help Center", "All notification"].map((item) => (
            <li key={item} className="px-6 py-3 hover:bg-gray-100 cursor-pointer">
              {item}
            </li>
          ))}
        </ul>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md max-w-2xl">
          ...
          <div className="flex items-center mb-6">
            <div className="w-20 h-20 rounded-full bg-gray-300 flex items-center justify-center mr-4">
              <span className="text-2xl text-white">AJ</span>
            </div>
          </div>
