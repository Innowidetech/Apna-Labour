...
const Home = () => {
  ...
  // 🔹 Dynamic routing helper (NO STATIC IDs)
  ...
  // Slider services example data
  const sliderServices = [
    { img: slider1, title: "Intense Cleaning (2 Bathrooms)", rating: 4.8, price: 1500 },
    { img: slider2, title: "Water Tank Cleaning (10Ltr)", rating: 4.6, price: 2500 },
    { img: slider3, title: "Bedroom Cleaning", rating: 4.7, price: 1800 },
    { img: slider4, title: "Plumbing Services", rating: 4.9, price: 2000 },
  ];
    ...
    <div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 py-10 sm:py-16 md:py-32 flex flex-col md:flex-row items-center rounded-3xl h-full">
          ...
          <div className="flex-1 text-white text-center md:text-center">
            <h1 className="text-3xl sm:text-3xl md:text-6xl font-bold leading-tight">
              Your Home, Our Work <br className="hidden md:block" /> Just a Click Away.
            </h1>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-8">
          ...
          <div className="relative space-y-4 pb-5 md:pb-0">
            ...
            <div className="flex justify-center mt-10">
              {/* 🔹 Dynamic Navigation */}
              <button
                onClick={() => goToService("Men Salon")}
                className="bg-[#003049] text-white font-semibold px-6 py-3 rounded-2xl shadow-md transition"
              >
                Book Now
              </button>
            </div>
            ...
            <div className="absolute -left-1/5 mb-8">
              <img src={plant} alt="Decorative Plant" className="w-20 h-20 sm:w-24 sm:h-24 md:w-48 md:h-48 object-contain" />
            </div>
          </div>

          <div className="w-full flex justify-center md:justify-end">
            <img src={massageService} alt="Deep Cleaning Service" className="w-full max-w-sm sm:max-w-md md:max-w-lg h-auto object-cover" />
          </div>
      ...
      <section className="py-12 px-6 md:px-12 bg-white">
        ...
        <div className="max-w-6xl mx-auto text-left mb-10">
          <h2 className="text-xl md:text-xl font-bold text-[#252525]">for your Hygiene</h2>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-lg">
            <img src={hygiene1} alt="Service 1" className="w-full h-64 object-cover" />
            <div className="absolute inset-0 bg-black/40 flex flex-col justify-between p-6">
              ...
              <button
                onClick={() => goToService("Cleaning & Pest Control")}
                className="bg-[#003049] text-white font-semibold w-28 py-2 rounded-xl shadow-md transition"
              >
                Book Now
              </button>
          ...
          {/* BOX 2 */}
          <div className="relative rounded-2xl overflow-hidden shadow-lg">
            <img src={hygiene2} alt="Service 2" className="w-full h-64 object-cover" />
            <div className="absolute inset-0 bg-black/40 flex flex-col justify-between p-6">
          ...
          {/* BOX 3 */}
          <div className="relative rounded-2xl overflow-hidden shadow-lg">
            <img src={hygiene3} alt="Service 3" className="w-full h-64 object-cover" />
            <div className="absolute inset-0 bg-black/40 flex flex-col justify-between p-6">
