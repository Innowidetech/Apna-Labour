...
const ServiceDetails = () => {
  ...
  // Determine if current service is casual labour
  const isCasualLabourService = id === "casual";
  ...
  useEffect(() => {
    ...
    if (id) {
      if (!isCasualLabourService) {
        ...
        // For casual labour service, clear subcategories and services
        setSubcategories([]);
        setSelectedSubcategoryId(null);
        setServices([]);
      }
      // Reset casual labour data on id change
      setCasualLabour([]);
    ...
    <>
      ...
      <section className="bg-[#EDF2FB] py-6 px-6 md:px-16">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-end">
          ...
          {/* Buttons for casual labour moved here right side below hero text */}
          <div className="w-full md:w-1/2 flex justify-end items-center space-x-4 mt-4 md:mt-0">
            ...
            {/* Show hero image only if NOT casual labour or always? You said below hero section so keep image too */}
            {!isCasualLabourService && (
              <img
      ...
      <div className="px-6 md:px-16 py-6">
        ...
        {/* Casual Labour Section for casual labour service only */}
        {isCasualLabourService && (
          <section className="mb-8">
            {/* The buttons moved above, so no need here */}
        ...
        {/* Services Section (only if subcategory selected and NOT casual labour) */}
