...
const Account = () => {
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      image: null, // leave null, since image is handled via URL
    });

    setDisplayName(profile.name || "");
    setProfileImageUrl(profile.image || null);
  }, [accountData]);
  ...
  const handleImageChange = (e) => {
    if (e.target.files && e.target.files[0]) {
      ...
      setProfileImageUrl(null); // clear image url preview when user uploads a new file
    }
  };
