...
const Account = () => {
  ...
  // Sidebar display data (name and image)
  ...
  // Map API response profile object to form and displayData
  useEffect(() => {
    ...
    setFormData({
      ...
      image: null, // Reset file input after loading existing data
    });
  ...
  const handleLogout = () => {
    localStorage.removeItem("token"); // your token key name consistency
