...
{step === "next" && (
  <>
    <h2 className="text-lg mb-6 text-left font-semibold">Complete Booking</h2>

    {/* Address Card */}
    <div className="bg-white shadow-md rounded-lg border border-gray-200 p-6 w-full">
      <h3 className="text-base font-medium mb-4">Register Address</h3>
      ...
      <div className="flex flex-col gap-4">
        ...
        <textarea
          ...
          className="border border-gray-300 px-3 py-2 rounded-md focus:outline-none focus:border-blue-500 resize-none"
        />

        <button
          className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md w-full font-medium"
    ...
    <div className="mt-6 bg-gray-50 border border-gray-200 rounded-lg p-4 text-gray-500">
      📅 Slot Booking (Coming Soon)
    </div>

    {/* Payment Button - Only show if address is saved */}
    {addressSaved && (
      <button className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-md w-full mt-6 font-medium">
        Proceed to Payment
      </button>
    )}
  </>
