...
// This is now at the same level as handleAddressSubmit
const handleSlotBooking = async () => {
  try {
    ...
    if (!slotData.bookingDate || !slotData.timeSlot) {
      toast.error("Please select booking date and time slot!");
      return;
    }
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
    <div className="bg-white rounded-xl w-full max-w-md p-6 relative shadow-lg">
      ...
      <input
        ...
        onChange={(e) =>
          setSlotData({ ...slotData, bookingDate: e.target.value })
        }
      />
      ...
      <select
        ...
        onChange={(e) =>
          setSlotData({ ...slotData, timeSlot: e.target.value })
        }
      >
