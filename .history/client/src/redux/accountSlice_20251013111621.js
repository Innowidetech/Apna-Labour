...
export const fetchAccountProfile = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return response.data.profile; // return inner profile object
    } catch (error) {
...
export const updateAccountProfile = createAsyncThunk(
  ...
  async (updatedData, { rejectWithValue }) => {
    try {
      ...
      return response.data.customer; // return updated customer
    } catch (error) {
      return rejectWithValue(
...
export const deactivateAccount = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return response.data; // should contain a message
    } catch (error) {
      return rejectWithValue(
