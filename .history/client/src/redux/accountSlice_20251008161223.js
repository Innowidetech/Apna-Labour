...
// ✅ Update customer profile (PUT) with file upload
export const updateAccountProfile = createAsyncThunk(
  ...
  async (updatedData, { rejectWithValue }) => {
    try {
      ...
      // Address fields
      formData.append("address.HNo", updatedData.address?.HNo || "");
      formData.append("address.street", updatedData.address?.street || "");
      formData.append("address.area", updatedData.address?.area || "");
      formData.append("address.landmark", updatedData.address?.landmark || "");
      formData.append("address.townCity", updatedData.address?.townCity || "");
      formData.append("address.state", updatedData.address?.state || "");
      formData.append("address.pincode", updatedData.address?.pincode || "");
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(deactivateAccount.fulfilled, (state, action) => {
        ...
        state.accountData = null; // clear profile after deactivation
      })
