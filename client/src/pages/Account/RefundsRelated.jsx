// src/pages/Account/HelpCenter/RefundsRelated.jsx
    ...
    const fetchHelpData = async () => {
      try {
        const response = await fetch(
          "https://apnalabour.onrender.com/api/customer/get-help-center/Refunds related"
        );
        const data = await response.json();
        console.log("Refunds Related API:", data);
