// src/pages/Painting/Painting.jsx
import React, { useState } from "react";
import { useNavigate } from "react-router-dom";
import workerImg from "../../assets/painting-man.png";

// Example images
import paintingImg from "../../assets/paintingImg.jpg";
import waterproofingImg from "../../assets/waterproofingImg.jpg";

// Sub-service images
import interiorImg from "../../assets/interiorImg.jpg";
import exteriorImg from "../../assets/exteriorImg.jpg";
import bathroomImg from "../../assets/interior.png";
...
const Painting = () => {
  ...
  const paintingServices = [
    { id: 1, name: "Full Home Painting", img: interiorImg },
    { id: 2, name: "Walls and Rooms Painting", img: exteriorImg },
  ];

  const waterproofingServices = [
    { id: 3, name: "Internal waterproofing", img: bathroomImg },
    { id: 4, name: "External waterproofing", img: roofImg },
  ];

  // Sub-services for modal
  const subServicesMap = {
    "Full Home Painting": [
      { id: 11, name: "Interior Painting", img: interiorImg, route: "/painting/interior" },
      { id: 12, name: "Exterior Painting", img: exteriorImg, route: "/painting/interior" },
    ],
    "Walls and Rooms Painting": [
      { id: 13, name: "Rooms and walls painting", img: interiorImg, route: "/painting/wallspainting" },
      { id: 14, name: "Full Home Painting", img: exteriorImg, route: "/painting/wallspainting" },
    ],
    "Internal waterproofing": [
      { id: 15, name: "Bathroom", img: bathroomImg, route: "/painting/waterproofing" },
      { id: 16, name: "Tile Grouting (Add-ons)", img: roofImg, route: "/painting/waterproofing" },
    ],
    "External waterproofing": [
      { id: 17, name: "Terrace & balcony waterproofing", price: "₹1499", img: roofImg, route: "/painting/externalwaterproofing" },
      { id: 18, name: "Large Roof", price: "₹2999", img: roofImg, route: "/painting/externalwaterproofing" },
    ],
  };

  // Most Demanding Services
  const mostDemandingServices = [
    { id: 21, name: "Interior 2BHK Painting", price: "₹2999", img: interiorImg },
    { id: 22, name: "Exterior Small House", price: "₹2499", img: exteriorImg },
    { id: 23, name: "Bathroom Waterproofing", price: "₹799", img: bathroomImg },
    { id: 24, name: "Roof Waterproofing", price: "₹1499", img: roofImg },
  ];
    ...
    <div className="w-full">
        ...
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center min-h-[220px]">
          <div className="text-center md:text-left mb-6 md:mb-0">
            ...
            <p className="mt-2 text-gray-600 text-sm md:text-base">
              Professional wall & home painting services.
            </p>
          </div>
          <img
            src={workerImg}
      ...
      <section className="py-10 px-6 md:px-16">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          >
            <img src={paintingImg} alt="Painting" className="w-full h-40 object-cover" />
          ...
          <div
            ...
            className="cursor-pointer relative rounded-lg overflow-hidden shadow-md"
          >
            <img src={waterproofingImg} alt="Waterproofing" className="w-full h-40 object-cover" />
            <div className="absolute inset-0 bg-black/40 flex items-center justify-center text-white text-xl font-bold">
              WATERPROOFING
            </div>
          </div>
      ...
      {selectedCategory === "waterproofing" && (
        <section className="py-10 px-6 md:px-16">
          <h3 className="text-xl font-semibold mb-6">Explore Waterproofing Services</h3>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {waterproofingServices.map((srv) => (
              <div
                key={srv.id}
                onClick={() => setSelectedService(srv)}
                className="cursor-pointer p-4 flex flex-col items-center border rounded-md hover:shadow-lg"
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="mt-3 flex justify-between items-center">
                  <button
                    onClick={() => setSelectedService(service)} // ✅ View details modal
                    className="text-blue-600 text-sm font-medium hover:underline"
                  >
                    View details
                  </button>
                  <button
                    onClick={() => setBookingService(service)} // ✅ Book modal
      ...
      {/* View Details Modal (Most Demanding) */}
