...
import other3 from "../../assets/otherClean3.png";
import other4 from "../../assets/otherClean4.png";

const services = [
  { id: 1, name: "Full Home Deep Cleaning", price: "₹2499", discount: "20% Off" },
  { id: 2, name: "Kitchen Deep Cleaning", price: "₹1299", discount: "15% Off" },
  { id: 3, name: "Bathroom Deep Cleaning", price: "₹799", discount: "10% Off" },
  { id: 4, name: "Sofa Shampoo Cleaning", price: "₹499", discount: "15% Off" },
];

const deepCleaningServices = [
  { id: 1, name: "Carpet Deep Cleaning", price: "₹699", rating: "4.9", reviews: "1021", img: deep1 },
  { id: 2, name: "Mattress Shampooing", price: "₹999", rating: "4.8", reviews: "835", img: deep2 },
  { id: 3, name: "Sofa Shampoo & Vacuum", price: "₹899", rating: "4.7", reviews: "1620", img: deep3 },
];
...
const DeepCleaning = () => {
  ...
  const appliances = [
    { id: 1, name: "Sofa", img: sofaImg },
    { id: 2, name: "Carpet", img: carpetImg },
    { id: 3, name: "Kitchen", img: kitchenImg },
    { id: 4, name: "Bathroom", img: bathroomImg },
    { id: 5, name: "Mattress", img: mattressImg },
  ];
  ...
  return (
    <>
      ...
      <section className="bg-[#EDF2FB] py-6 px-6 md:px-16">
        <div className="container mx-auto flex flex-col md:flex-row justify-between">
          <div className="w-full md:w-1/2 text-left flex flex-col justify-end">
            <h2 className="text-2xl font-bold text-gray-800">Deep Cleaning Services</h2>
            <p className="text-gray-600 mt-2">
              Professional deep cleaning for your home, furniture, and more.
            </p>
          </div>
          <div className="w-full md:w-1/2 flex justify-end items-end">
            <img src={manImg} alt="Deep Cleaning" className="max-w-xs md:max-w-sm lg:max-w-md self-end" />
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-6 md:px-16 bg-white">
        <h3 className="text-xl font-semibold mb-8">Popular Deep Cleaning</h3>
      ...
      {selectedService && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex justify-center items-center z-50">
          <div className="bg-white rounded-2xl shadow-lg p-6 w-[95%] md:w-[900px] relative">
            ...
            <p className="text-sm text-gray-500 mb-4">⭐ 4.8 (5.2k bookings)</p>
