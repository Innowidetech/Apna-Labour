...
const Fan = () => {
  ...
  const [bookingService, setBookingService] = useState(null); // Book modal
  ...
  const services = [
    {
      ...
      price: "₹249",
      rating: "★★★★☆",
      description: "Professional fan repair service with 1-year warranty.",
      img: fanRepairImg,
      options: [
        { name: "Wall Fan", price: "₹249" },
        { name: "Ceiling Fan", price: "₹299" },
      ],
    },
    {
      id: 2,
      ...
      price: "₹299",
      rating: "★★★★☆",
      description: "Safe and reliable fan installation by experts.",
      img: fanRepairImg,
      options: [
        { name: "Wall Fan Install", price: "₹299" },
        { name: "Ceiling Fan Install", price: "₹349" },
      ],
    },
  ];
  ...
  const installations = [
    {
      ...
      price: "₹349",
      rating: "★★★★☆",
      description: "Professional ceiling fan installation for home or office.",
      img: fanRepairImg,
      options: [
        { name: "Basic Install", price: "₹349" },
        { name: "Premium Install", price: "₹399" },
      ],
    },
  ];
  ...
  return (
    <div className="w-full">
      {/* Hero Section */}
    {/* Hero Section */}
<section className="bg-[#EDF2FB] py-4 md:py-6 flex flex-col md:flex-row items-center justify-between px-6 md:px-16">
  {/* Left Heading */}
  <div className="mb-4 md:mb-0">
    <h2 className="text-2xl font-bold text-gray-800">Fan</h2>
  ...
  />
      ...
      <section className="py-10 px-6 md:px-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((srv) => (
            <div key={srv.id} className="border rounded-lg p-4 shadow-sm hover:shadow-md transition">
      ...
      <section className="py-10 px-6 md:px-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {installations.map((inst) => (
            <div key={inst.id} className="border rounded-lg p-4 shadow-sm hover:shadow-md transition">
              <img src={inst.img} alt={inst.title} className="w-full h-40 object-cover rounded-md mb-3" />
