...
// Doorbell service images
import doorbellRepairImg from "../assets/doorbell.jpg"; 
import videoDoorbellImg from "../assets/doorbell.jpg"; 
import smartBellImg from "../assets/doorbell.jpg"; 

const Doorbell = () => {
  const navigate = useNavigate();

  // Categories (same across all service pages)
  const categories = [
