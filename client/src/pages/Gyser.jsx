...
import geyserImg from "../assets/geyser.png"; // main geyser image

// Gyser specific images
import geyserRepairImg from "../assets/geyser.png";
import geyserServiceImg from "../assets/geyser.png";
import geyserInstallationImg from "../assets/geyser.png";
...
const Gyser = () => {
  ...
  const categories = [
    ...
    { name: "Gyser", img: geyserImg, route: "/gyser" },
  ];
        ...
        <div className="flex gap-6 overflow-x-auto pb-2">
          {categories.map((cat, idx) => (
            ...
            >
              ...
              />
              <p className="mt-2 text-sm font-medium text-[#023E8A]">
                {cat.name}
              </p>
            </div>
          ))}
