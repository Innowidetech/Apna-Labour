// src/pages/AirCooler.jsx
import React, { useState } from "react";

// Hero & Appliances
import manImg from "../../assets/aircoolerHero.png"; // <-- replace with correct Air Cooler hero image
...
// Air Cooler Services Images
import coolerRepair1 from "../../assets/coolerRepair1.png";
import coolerRepair2 from "../../assets/coolerRepair2.png";
import coolerRepair3 from "../../assets/coolerRepair3.png";

import waterPumpImg from "../../assets/coolerWaterPump.png";
import coolerCleaningImg from "../../assets/coolerCleaning.png";

const services = [
  { id: 1, name: "Water Pump Replacement", img: coolerImg, price: "₹799", discount: "10% Off" },
  { id: 2, name: "Cooling Pad Replacement", img: coolerImg, price: "₹999", discount: "12% Off" },
  { id: 3, name: "Motor Repair", img: coolerImg, price: "₹1299", discount: "15% Off" },
  { id: 4, name: "General Servicing", img: coolerImg, price: "₹499", discount: "8% Off" },
];

const repairCoolerServices = [
  { id: 1, name: "Not Cooling Properly", price: "₹699", rating: "4.8", reviews: "980", img: coolerRepair1 },
  { id: 2, name: "Water Leakage Issue", price: "₹799", rating: "4.7", reviews: "1150", img: coolerRepair2 },
  { id: 3, name: "Unusual Noise / Vibration", price: "₹899", rating: "4.6", reviews: "870", img: coolerRepair3 },
  { id: 4, name: "Complete Overhaul", price: "₹1599", rating: "4.9", reviews: "1340", img: coolerRepair1 },
];

const otherServices = [
  { id: 1, name: "Water Pump Service", price: "₹499", rating: "4.8", reviews: "456", img: waterPumpImg },
  { id: 2, name: "Deep Cleaning", price: "₹699", rating: "4.7", reviews: "620", img: coolerCleaningImg },
];
    ...
    <>
      ...
      <section className="bg-[#EDF2FB] py-6 px-6 md:px-16">
        <div className="container mx-auto flex flex-col md:flex-row justify-between">
          <div className="w-full md:w-1/2 text-left flex flex-col justify-end">
            <h2 className="text-2xl font-bold text-gray-800">Air Cooler Repair</h2>
          </div>
          <div className="w-full md:w-1/2 flex justify-end items-end">
            <img src={manImg} alt="Air Cooler Repair" className="max-w-xs md:max-w-sm lg:max-w-md self-end" />
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-6 md:px-16 bg-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {repairCoolerServices.map((service) => (
            <div
              key={service.id}
      ...
      <section className="py-10 px-6 md:px-16 bg-white">
        ...
        <p className="text-gray-600 mb-5 text-sm">Air Cooler Maintenance</p>
      ...
      {selectedAppliance && (
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex justify-center items-center z-50">
          <div className="bg-white rounded-2xl shadow-lg p-6 w-[95%] md:w-[900px] relative">
            ...
            <p className="text-sm text-gray-500 mb-4">⭐ 4.75 (8.5k bookings)</p>
